...
* **Citations shown in a Zotero style.** The note still holds the pandoc citation; reading view and live preview draw it as the style chosen in the settings writes it, page, prefix, suffix and suppressed author included. Putting the cursor inside a citation shows it as written.
