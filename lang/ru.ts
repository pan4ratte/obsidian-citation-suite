...
export default {
	...
	NOTICE_FOOTNOTE_IN_FOOTNOTE:
		"Курсор стоит в тексте сноски, а сноска в сноске невозможна.",
	...
	SETTING_FOOTNOTE_KEEP_NAMED_NAME:
		"Не менять именованные сноски при перенумерации",
	SETTING_FOOTNOTE_KEEP_NAMED_DESC:
		"Команда, которая нумерует сноски по порядку, оставляет метки с названиями, например [^kuhn], как есть и нумерует только сноски, помеченные номером с текстом до и после номера из настроек выше: арабскими цифрами или римскими, если сноски нумеруются римскими цифрами того же регистра.",
	...
	BIBLIOGRAPHY_NO_STYLE:
		"Выберите стиль в настройках Citation Suite, и здесь появится список литературы заметки, оформленный по этому стилю.",
