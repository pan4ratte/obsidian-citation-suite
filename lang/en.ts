...
export default {
	...
	SETTING_NOTE_STYLE_NAME: "Style a note in the style and language of its properties",
	SETTING_NOTE_STYLE_DESC: "When a note's properties give csl (or citation-style) or lang, as Pandoc reads them, the preview is styled the way the export will be: in that style, in that language, and with locator labels in that language. The style file is looked for next to the note, in the vault's root and in the csl folder of Pandoc's data directory, and a style URL among Zotero's styles.",
