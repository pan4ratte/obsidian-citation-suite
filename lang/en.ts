...
export default {
	...
	// The window for picking a source from the bibliography file, where Zotero
	// cannot be reached.
	...
	BIBLIOGRAPHY_SELECT_ALL: "Select all sources in Zotero",
	BIBLIOGRAPHY_SELECT_NOT_FOUND: "Zotero no longer has this note's sources.",
	BIBLIOGRAPHY_SELECT_ELSEWHERE: "Zotero shows one library at a time, so the sources were selected in the library holding the most of them. Selected:",
	BIBLIOGRAPHY_SELECT_MISSING: "Zotero no longer has some of this note's sources. Selected:",
